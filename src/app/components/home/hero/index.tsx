  ...
  return (
    <section>
      <div className='relative w-full pt-44 2xl:pb-20 pb-10 before:absolute before:w-full before:h-full before:bg-linear-to-r before:from-blue_gradient before:via-white before:to-yellow_gradient before:rounded-full before:top-24 before:blur-3xl before:-z-10 dark:before:from-dark_blue_gradient dark:before:via-black dark:before:to-dark_yellow_gradient dark:before:rounded-full dark:before:blur-3xl dark:before:-z-10'>
        <div className='container relative z-10 flex flex-col justify-center items-center h-[75vh]'>
          <div ref={ref} className='flex flex-col gap-8'>
            ...
            <motion.div
              ...
              <h1 className='w-full text-center'>
                <span className='font-medium text-4xl md:text-5xl lg:text-6xl block leading-snug'>Your work deserves presence</span>
                <span className='instrument-font italic font-normal text-6xl md:text-7xl lg:text-8xl dark:text-white/70 block mt-2'>
                  We build it into the internet.
                </span>
              </h1>
              <p className='max-w-38 text-dark_black/60 dark:text-white/60 mb-12'>
              For Brands. For Creators             </p>
            </motion.div>
                ...
                <div className='flex items-center gap-7'>
                  <ul className='avatar flex flex-row items-center'>
                    {avatarList?.avatarList ? (
                      ...
                      <li className='text-sm text-gray-500'>Loading avatars...</li>
                    )}
                  </ul>
